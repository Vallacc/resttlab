...
<head>
    ...
    <link href="/adminAsstes/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <?= $this->include('halaman/templates/sidebar'); ?>
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Topbar -->
            <?= $this->include('halaman/templates/topbar'); ?>
            <!-- End of Topbar -->
